...
```
cd existing_repo
git remote add origin http://git.in.minelab/nagai/test-github-mirroring.git
git branch -M main
...
- [ ] [Set up project integrations](http://git.in.minelab/nagai/test-github-mirroring/-/settings/integrations)
